...
#Diffeomorphic registration. POLY[degree, sigma_smooth, q_levels, cprop, drop_zeros]
python dipyreg.py target/$target reference/$reference $affine warp --metric=POLY[9,1.7,256,0.95,1] --iter=100,100,25 --step_length=0.25
date
