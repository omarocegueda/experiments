...
affine='""'
python dipyreg.py ref_moving/$ref_moving ref_fixed/$ref_fixed $affine warp --intermediate=target/$target --inter_to_reference_aff=$affine_ref_fixed --inter_to_target_aff=$affine_ref_moving --metric=EM[1.7,256,20,demons] --iter=100,100,25 --step_length=0.25
date
