...
python dipyreg_affine.py target/$target reference/$reference warp --transforms=TRANSLATION,RIGID,AFFINE --metric=MI[32] --iter=1000,1000,1000 --factors=4,2,1 --sigmas=3,1,0 --method=CGGS
date
