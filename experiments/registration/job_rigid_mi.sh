...
python dipyreg_affine.py target/$target reference/$reference warp --transforms=TRANSLATION,RIGID --metric=MI[32,0.3] --iter=1000,1000,1000 --factors=4,2,1 --sigmas=3,1,0 --method=L-BFGS-B
date
